...
class _TabsState extends State<Tabs> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: Container( //FloatingActionButton 包裹一层Container
        height: 60,  //调整FloatingActionButton的大小
        width: 60,
        padding: const EdgeInsets.all(5),
        margin: const EdgeInsets.only(top: 5),  //调整FloatingActionButton的位置
        decoration: BoxDecoration(//容器的背景
          color: Colors.white,
          borderRadius: BorderRadius.circular(30),
        ),
        child: FloatingActionButton(
            backgroundColor:_currentIndex==2?Colors.red:Colors.blue, //设置颜色
